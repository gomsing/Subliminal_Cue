...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\vcl\\Dropbox\\Dropbox\\Exp_Eugene\\subliminal cue\\experiment_final_0803.py',
...
fixpoint_2 = visual.ShapeStim(
    win=win, name='fixpoint_2', vertices='cross',units='deg', 
    size=(1, 1),
    ori=0, pos=(0, 0),
...
# Initialize components for Routine "staircase_tutorial"
staircase_tutorialClock = core.Clock()
thStore = []
corrStore = []
targLoc = [0,0]
movingaccu = ''
fixpoint_3 = visual.ShapeStim(
    win=win, name='fixpoint_3', vertices='cross',units='deg', 
    size=(1, 1),
    ori=0, pos=(0, 0),
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[-1.000,-1.000,-1.000], fillColorSpace='rgb',
    opacity=1, depth=-1.0, interpolate=True)
sub_cue_3 = visual.Polygon(
    win=win, name='sub_cue_3',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[0,0],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-2.0, interpolate=True)
mask1_5 = visual.Polygon(
    win=win, name='mask1_5',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[3, 3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-3.0, interpolate=True)
mask2_5 = visual.Polygon(
    win=win, name='mask2_5',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[3,-3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-4.0, interpolate=True)
mask2_6 = visual.Polygon(
    win=win, name='mask2_6',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[-3,3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-5.0, interpolate=True)
mask2_7 = visual.Polygon(
    win=win, name='mask2_7',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[-3,-3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
...
fixpoint = visual.ShapeStim(
    win=win, name='fixpoint', vertices='cross',units='deg', 
    size=(1, 1),
    ori=0, pos=(0, 0),
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[-1.000,-1.000,-1.000], fillColorSpace='rgb',
    opacity=1, depth=-1.0, interpolate=True)
sub_cue_2 = visual.Polygon(
    win=win, name='sub_cue_2',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[0,0],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-2.0, interpolate=True)
mask1_2 = visual.Polygon(
    win=win, name='mask1_2',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[3, 3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-3.0, interpolate=True)
mask2_2 = visual.Polygon(
    win=win, name='mask2_2',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[3,-3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-4.0, interpolate=True)
mask2_3 = visual.Polygon(
    win=win, name='mask2_3',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[-3,3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
    opacity=1, depth=-5.0, interpolate=True)
mask2_4 = visual.Polygon(
    win=win, name='mask2_4',units='deg', 
    edges=90, size=[2, 2],
    ori=0, pos=[-3,-3],
    lineWidth=0, lineColor=[1,1,1], lineColorSpace='rgb',
    fillColor=[0.506,0.506,0.506], fillColorSpace='rgb',
...
Instruction_1Components = [image, key_resp_8]
...
tutorial = data.TrialHandler(nReps=10, method='random', 
    extraInfo=expInfo, originPath=-1,
    trialList=[None],
    seed=None, name='tutorial')
thisExp.addLoop(tutorial)  # add the loop to the experiment
thisTutorial = tutorial.trialList[0]  # so we can initialise stimuli with some values
# abbreviate parameter names if possible (e.g. rgb = thisTutorial.rgb)
if thisTutorial != None:
    for paramName in thisTutorial:
        exec('{} = thisTutorial[paramName]'.format(paramName))

for thisTutorial in tutorial:
    currentLoop = tutorial
    # abbreviate parameter names if possible (e.g. rgb = thisTutorial.rgb)
    if thisTutorial != None:
        for paramName in thisTutorial:
            exec('{} = thisTutorial[paramName]'.format(paramName))
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        # *fixpoint_2* updates
        if t >= 0 and fixpoint_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            fixpoint_2.tStart = t
            fixpoint_2.frameNStart = frameN  # exact frame index
            fixpoint_2.setAutoDraw(True)
        frameRemains = 0 + 1- win.monitorFramePeriod * 0.75  # most of one frame period left
        if fixpoint_2.status == STARTED and t >= frameRemains:
            fixpoint_2.setAutoDraw(False)
    ...
    # ------Prepare to start Routine "staircase_tutorial"-------
    t = 0
    staircase_tutorialClock.reset()  # clock
    frameN = -1
    continueRoutine = True
    # update component parameters for each repeat
    import random
    ...
    #target circle selection(randomly out of 4)
    Position = ['leftUpPos', 'leftDownPos', 'rightUpPos', 'rightDownPos']
    Position1 = np.random.choice(Position, 4, p=[0.25, 0.25, 0.25, 0.25], replace = False)
    
    
    
    if Position1[0] == 'leftUpPos':
        targLoc = leftUpPos
        correctAns = 'f'
    elif Position1[0] == 'leftDownPos':
        targLoc = leftDownPos
        correctAns = 'v'
    elif Position1[0] == 'rightUpPos':
        targLoc = rightUpPos
        correctAns = 'j'
    elif Position1[0] == 'rightDownPos':
        targLoc = rightDownPos
        correctAns = 'n'
        
    
    
    
    sub_cue_3.setPos(targLoc)
    key_resp_10 = event.BuilderKeyResponse()
    # keep track of which components have finished
    staircase_tutorialComponents = [fixpoint_3, sub_cue_3, mask1_5, mask2_5, mask2_6, mask2_7, key_resp_10]
    for thisComponent in staircase_tutorialComponents:
        if hasattr(thisComponent, 'status'):
            thisComponent.status = NOT_STARTED
    
    # -------Start Routine "staircase_tutorial"-------
    while continueRoutine:
        # get current time
        t = staircase_tutorialClock.getTime()
        frameN = frameN + 1  # number of completed frames (so 0 is the first frame)
        # update/draw components on each frame
        
        # *fixpoint_3* updates
        if t >= 0.0 and fixpoint_3.status == NOT_STARTED:
            # keep track of start time/frame for later
            fixpoint_3.tStart = t
            fixpoint_3.frameNStart = frameN  # exact frame index
            fixpoint_3.setAutoDraw(True)
        
        # *sub_cue_3* updates
        if t >= 0.2 and sub_cue_3.status == NOT_STARTED:
            # keep track of start time/frame for later
            sub_cue_3.tStart = t
            sub_cue_3.frameNStart = frameN  # exact frame index
            sub_cue_3.setAutoDraw(True)
        frameRemains = 0.2 + 0.2- win.monitorFramePeriod * 0.75  # most of one frame period left
        if sub_cue_3.status == STARTED and t >= frameRemains:
            sub_cue_3.setAutoDraw(False)
        
        # *mask1_5* updates
        if (sub_cue_3.status==FINISHED) and mask1_5.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask1_5.tStart = t
            mask1_5.frameNStart = frameN  # exact frame index
            mask1_5.setAutoDraw(True)
        if mask1_5.status == STARTED and t >= (mask1_5.tStart + 0.033):
            mask1_5.setAutoDraw(False)
        
        # *mask2_5* updates
        if frameN >= sub_cue_3.status==FINISHED and mask2_5.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask2_5.tStart = t
            mask2_5.frameNStart = frameN  # exact frame index
            mask2_5.setAutoDraw(True)
        if mask2_5.status == STARTED and t >= (mask2_5.tStart + 0.033):
            mask2_5.setAutoDraw(False)
        
        # *mask2_6* updates
        if frameN >= sub_cue_3.status==FINISHED and mask2_6.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask2_6.tStart = t
            mask2_6.frameNStart = frameN  # exact frame index
            mask2_6.setAutoDraw(True)
        if mask2_6.status == STARTED and t >= (mask2_6.tStart + 0.033):
            mask2_6.setAutoDraw(False)
        
        # *mask2_7* updates
        if frameN >= sub_cue_3.status==FINISHED and mask2_7.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask2_7.tStart = t
            mask2_7.frameNStart = frameN  # exact frame index
            mask2_7.setAutoDraw(True)
        if mask2_7.status == STARTED and t >= (mask2_7.tStart + 0.033):
            mask2_7.setAutoDraw(False)
        
        # *key_resp_10* updates
        if t >= mask1_5.status == FINISHED and key_resp_10.status == NOT_STARTED:
            # keep track of start time/frame for later
        ...
        if key_resp_10.status == STARTED:
            theseKeys = event.getKeys(keyList=['f', 'v', 'j', 'n'])
    ...
    # -------Ending Routine "staircase_tutorial"-------
    for thisComponent in staircase_tutorialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    ...
    # store data for tutorial (TrialHandler)
    tutorial.addData('key_resp_10.keys',key_resp_10.keys)
    tutorial.addData('key_resp_10.corr', key_resp_10.corr)
    if key_resp_10.keys != None:  # we had a response
        tutorial.addData('key_resp_10.rt', key_resp_10.rt)
    # the Routine "staircase_tutorial" was not non-slip safe, so reset the non-slip timer
    routineTimer.reset()
    thisExp.nextEntry()
    
# completed 10 repeats of 'tutorial'
...
win.mouseVisible = False 
# keep track of which components have finished
instruction_2Components = [image_2, key_resp_9]
...
# --------Prepare to start Staircase "staircases" --------
# set up handler to look after next chosen value etc
staircases = data.StairHandler(startVal=100, extraInfo=expInfo,
    stepSizes=[8,4,2,2,1], stepType='lin',
    nReversals=8, nTrials=120, 
    nUp=1, nDown=3,
    minVal=1, maxVal=120,
    originPath=-1, name='staircases')
thisExp.addLoop(staircases)  # add the loop to the experiment
level = thisStaircase = 100  # initialise some vals

for thisStaircase in staircases:
    currentLoop = staircases
    level = thisStaircase
    ...
    sub_cue_2.setPos(targLoc)
    key_resp_5 = event.BuilderKeyResponse()
    # keep track of which components have finished
    staircaseComponents = [fixpoint, sub_cue_2, mask1_2, mask2_2, mask2_3, mask2_4, key_resp_5]
    for thisComponent in staircaseComponents:
        if hasattr(thisComponent, 'status'):
            thisComponent.status = NOT_STARTED
    
    # -------Start Routine "staircase"-------
    while continueRoutine:
        # get current time
        ...
        # *fixpoint* updates
        if t >= 0.0 and fixpoint.status == NOT_STARTED:
            # keep track of start time/frame for later
            fixpoint.tStart = t
        ...
        # *sub_cue_2* updates
        if t >= 0.2 and sub_cue_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            sub_cue_2.tStart = t
            sub_cue_2.frameNStart = frameN  # exact frame index
            sub_cue_2.setAutoDraw(True)
        if sub_cue_2.status == STARTED and frameN >= (sub_cue_2.frameNStart + level):
            sub_cue_2.setAutoDraw(False)
        
        # *mask1_2* updates
        if (sub_cue_2.status==FINISHED) and mask1_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask1_2.tStart = t
            mask1_2.frameNStart = frameN  # exact frame index
            mask1_2.setAutoDraw(True)
        if mask1_2.status == STARTED and t >= (mask1_2.tStart + 0.033):
            mask1_2.setAutoDraw(False)
        
        # *mask2_2* updates
        if frameN >= sub_cue_2.status==FINISHED and mask2_2.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask2_2.tStart = t
            mask2_2.frameNStart = frameN  # exact frame index
            mask2_2.setAutoDraw(True)
        if mask2_2.status == STARTED and t >= (mask2_2.tStart + 0.033):
            mask2_2.setAutoDraw(False)
        
        # *mask2_3* updates
        if frameN >= sub_cue_2.status==FINISHED and mask2_3.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask2_3.tStart = t
            mask2_3.frameNStart = frameN  # exact frame index
            mask2_3.setAutoDraw(True)
        if mask2_3.status == STARTED and t >= (mask2_3.tStart + 0.033):
            mask2_3.setAutoDraw(False)
        
        # *mask2_4* updates
        if frameN >= sub_cue_2.status==FINISHED and mask2_4.status == NOT_STARTED:
            # keep track of start time/frame for later
            mask2_4.tStart = t
            mask2_4.frameNStart = frameN  # exact frame index
            mask2_4.setAutoDraw(True)
        if mask2_4.status == STARTED and t >= (mask2_4.tStart + 0.033):
            mask2_4.setAutoDraw(False)
        
        # *key_resp_5* updates
        if t >= mask1_2.status == FINISHED and key_resp_5.status == NOT_STARTED:
            # keep track of start time/frame for later
            key_resp_5.tStart = t
    ...
    for thisComponent in staircaseComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    thStore.append(level)
    corrStore.append(key_resp_5.corr)
    subcue_t = mask1_2.tStart - sub_cue_2.tStart
    staircases.addOtherData('subcue_time', subcue_t)
    reversal = staircases.reversalPoints
    reversal_value = staircases.reversalIntensities
    
    if len(reversal) > 9:
        staircases.finished = True
    
    staircases.addOtherData('reversal', staircases.reversalPoints)
    staircases.addOtherData('reversal_value', reversal_value)
    # check responses
    ...
    # store data for staircases (StairHandler)
    staircases.addResponse(key_resp_5.corr)
    staircases.addOtherData('key_resp_5.rt', key_resp_5.rt)
...
win.mouseVisible = False 
# keep track of which components have finished
instruction_3Components = [image_3, key_resp_11]
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if sub_cue_4.status == STARTED and frameN >= (sub_cue_4.frameNStart + 10):
